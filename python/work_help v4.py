...
menu_frames = {category: tk.Frame(root) for category in submenu_items}

# Create buttons for each category to display its submenu
for category in submenu_items.keys():
...
remove_item_btn = tk.Button(order_frame, text="Remove Selected Item", command=remove_selected_item, bg='slategrey', fg='white', font=button_font)
remove_item_btn.pack(fill='x')

# Button to clear the order
clear_order_btn = tk.Button(order_frame, text="Clear Order", command=clear_order, bg='slategrey', fg='white', font=button_font)
clear_order_btn.pack(fill='x')

# Button to save the order
save_btn = tk.Button(order_frame, text="Save Order", command=save_order, bg='slategrey', fg='white', font=button_font)
save_btn.pack(fill='x')

# Start with the first submenu visible
first_category = next(iter(submenu_items))
